...
## authtoken
*Attention, authtoken is required now because of a tricky ngrok [bug #27](https://github.com/bubenshchykov/ngrok/issues/27).* Please go to ngrok 2.0 dashboard and obtain an authtoken. Authtoken for ngrok 1.0 won't work. Many advanced features of the ngrok.com service anyway require authtoken, so it's a good think anyway. As alternative, use module version 0.1.99 which uses ngrok 1.0 and doesn't require an authtoken.
